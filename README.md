...
| 11 | 3 | 0.4s      | 0.7s        | 0.8s       |
| 11 | 4 | 2.5s      | 3.7s        | 5.1s       |
| 11 | 5 | 5.5s      | 3.1s        | 11.1s      |
| -  | - | -         | -           | -          |
| 12 | 0 | 0.0s      | 0.0s        | 0.0s       |
| 12 | 1 | 0.0s      | 0.0s        | 0.0s       |
| 12 | 2 | 0.1s      | 0.4s        | 0.2s       |
| 12 | 3 | 0.9s      | 1.7s        | 2.0s       |
| 12 | 4 | 13.3s     | 10.6s       | 28.1s      |
| 12 | 5 | 32.1s     | 57.5s       | 1m 8.4s    |
| -  | - | -         | -           | -          |
| 13 | 0 | 0.0s      | 0.0s        | 0.0s       |
| 13 | 1 | 0.0s      | 0.1s        | 0.0s       |
| 13 | 2 | 0.2s      | 1.1s        | 0.3s       |
| 13 | 3 | 4.2s      | 19.7s       | 10.6s      |
| 13 | 4 | 1m 17.4s  | 2m 24.0s    | ?          |
| 13 | 5 | 6m 13.9s  | 12m 38.6s   | ?          |
| 13 | 6 | 23m 56.9s | 26m 33.3s   | ?          |
| -  | - | -         | -           | -          |
| 14 | 0 | 0.0s      | 0.0s        | ?          |
| 14 | 1 | 0.0s      | 0.5s        | ?          |
| 14 | 2 | 0.3s      | 6.3s        | ?          |
| 14 | 3 | 9.3s      | 53.3s       | ?          |
| 14 | 4 | 5m 52.2s  | 22m 10.1s   | ?          |
