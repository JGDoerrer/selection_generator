...
| 11 | 3 | 0.4s      | 1.8s        | 0.8s       |
| 11 | 4 | 2.5s      | 7.0s        | 5.1s       |
| 11 | 5 | 5.5s      | 5.8s        | 11.1s      |
| -  | - | -         | -           | -          |
| 12 | 0 | 0.0s      | 0.0s        | 0.0s       |
| 12 | 1 | 0.0s      | 0.3s        | 0.0s       |
| 12 | 2 | 0.1s      | 2.4s        | 0.2s       |
| 12 | 3 | 0.9s      | 5.6s        | 2.0s       |
| 12 | 4 | 13.3s     | 25.0s       | 28.1s      |
| 12 | 5 | 32.1s     | 1m 51.4s    | 1m 8.4s    |
| -  | - | -         | -           | -          |
| 13 | 0 | 0.0s      | 0.0s        | 0.0s       |
| 13 | 1 | 0.0s      | 1.9s        | 0.0s       |
| 13 | 2 | 0.2s      | 7.6s        | 0.3s       |
| 13 | 3 | 4.2s      | 1m 12.0s    | 10.6s      |
| 13 | 4 | 1m 17.4s  | 5m 51.6s    | ?          |
| 13 | 5 | 6m 13.9s  | 25m 15.4s   | ?          |
| 13 | 6 | 23m 56.9s | 48m 5.0s    | ?          |
| -  | - | -         | -           | -          |
| 14 | 0 | 0.0s      | 0.0s        | ?          |
| 14 | 1 | 0.0s      | 11.1s       | ?          |
| 14 | 2 | 0.3s      | 46.5s       | ?          |
