...
Two posets $P$ and $Q$ are \emph{isomorphic} if there is a bijective mapping $\varphi: \Omega_P \to \Omega_Q$ such that $(u, v) \in P \iff (\varphi(u), \varphi(v)) \in Q$ for all $u, v \in \Omega_P$.
...
\begin{definition}[Predecessor] \label{definition:predecessor_calculation}\enlargethispage{2\baselineskip}
