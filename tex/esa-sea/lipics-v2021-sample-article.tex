...
\begin{enumerate}
  ...
  \item Predecessors with additional elements of which at least is not involved in the comparison.
\end{enumerate}
...
\subparagraph{Predecessors with additional elements of which at least is not involved in the comparison.}
