...
\todo[inline]{define less/ greater here. Probably best to define them as sets.

Let $\less{P}{v}$ denote the number of elements smaller than $v$ in poset $P$.
Let $\greater{P}{u}$ denote the number of elements greater than $u$ in poset $P$.
}
...
\begin{definition}[Predecessor] \label{definition:predecessor_calculation}
  ...
  \begin{enumerate}
    ...
    \item $V_j(\pchild{Q}{a}{b}) \le V_i(P)$ and
    \item $V_j(Q) \neq V_i(P)$.
  \end{enumerate}
\end{definition}
...
\begin{table}[!t]
  ...
  \begin{tabular}{c|c|l|l|l}
    ...
    15  & 7   & 14d 1h 51m (old) & 1d 3h 7m          & >5d              \\ % TODO: explain "old"
    \hline
    16  & 0   & -                & 0.0s              & -                \\
    16  & 1   & -                & 12.3s             & -                \\
    16  & 2   & -                & 1m 55.1s          & -                \\
