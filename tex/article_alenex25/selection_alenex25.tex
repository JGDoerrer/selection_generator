...
\title{\Large Exact Lower Bounds for the Number of Comparisons in Selection\relatedversion}
...
\begin{abstract} \small\baselineskip=9pt
  ...
  Our results comprise optimal algorithms for $n$ up to 15 and arbitrary $i$, and for $n=16$ when $i \leq 6$.
