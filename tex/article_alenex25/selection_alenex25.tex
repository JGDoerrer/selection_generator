...
\begin{proof} \label{proof:predecessor_calculation}
  Since $(Q, j)$ is a predecessor of $(P, i)$, there exists a comparison $(a, b)$ such that $V_j(\pchild{Q}{a}{b}) = V_i(P)$ by condition 1, and $V_j(\pchild{Q}{b}{a}) \leq V_i(P)$ by condition 2.
  Given that $V_j(Q) \leq \max\{V_j(\pchild{Q}{a}{b}), V_j(\pchild{Q}{b}{a})\} + 1$, it follows that $V_j(Q) \leq V_i(P) + 1$.
\end{proof}
