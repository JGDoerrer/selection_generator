...
For the backward search we use \texttt{nauty} to compute a canonical representative.
...
% TODO: embedd the following figure
\begin{figure}[!b]
  \centering
...
% TODO: Summarize the following paragraph
...
% Let's assume that both searches are started in parallel.
