...
The selection problem is, given a poset $R$ and an integer $i$, to determine the $i$-th smallest of the $n$ elements in $\Omega_R$ where we already know the relations $R$.
...
\todo[inline]{This def could be text}
