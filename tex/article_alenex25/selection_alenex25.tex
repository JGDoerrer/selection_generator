...
The first approach, which we will call forward search in the remainder of this article, an improvement to the minimax algorithm also used by Gasarch et.\ al\@.~\cite{Gasarch1996} and Oksanen~\cite{Oksanen2006,Oksanen}.
...
We denote by $\pchild{P}{a}{b}$ the transitive closure of $P \cup \{(a, b)\}$.\todo{alternativ $P_{a<b}$}
