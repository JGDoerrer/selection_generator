...
\begin{table}[!t]
  ...
  \begin{tabular}{c|c|r|r}
    ...
    16  & 5   & $211.051705 \cdot 10^6$ & $275.3 \cdot 10^6$       \\
...
We conclude this work by talking about promising direction for further research in this area.
...
However, that lead to a negative $4\sqrt{n}$ term in the resulting lower bound, cancelling out any improvement over just counting the compatible solutions.
