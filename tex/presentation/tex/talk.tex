...
\else
    ...
    %   (default: empty)
    \usetheme[
        titlePageUniversityLogo=../gfx/logos/unistuttgart_logo_deutsch_cmyk_invertiert.png,
        thanksPageBigGraphicsScale=0.175,
        thanksPageBigGraphics=../gfx/C++_logo.png,
...
\institute{{\bf Betreuer:} Florian Stober}
\date{26. Juni 2023}
