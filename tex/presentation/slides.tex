...
\begin{frame}{\insertsection}
  ...
  \begin{tabular}{|p{6cm}|p{6cm}|}
    ...
    \raggedright \begin{itemize}
                 ...
                 \end{itemize} &
     \begin{itemize}
                   \item[...] stellte einen Computersuch-Algorithmus online, der die unteren Schranken von Gasarch et al. übertrifft.
                 \end{itemize}
...
\begin{frame}{\insertsection}
  ...
  \begin{figure}[!b]
    ...
    \caption{$n=4,i=1,\text{upper\_bound}=3$}
...
\begin{frame}{\insertsection}
  \begin{figure}[!b]
    ...
    \caption{$n=4,i=1,\text{upper\_bound}=4$}
