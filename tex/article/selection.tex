...
\begin{figure}[h!]
  ...
  \centering
  \caption{Anzahl Posets vs. Anzahl Vergleiche für $n=12, i=5$ (rot: backward, blue: forward)}
  \label{fig:backward_forward_count}
\end{figure}

Wie Abbildung~\ref{fig:backward_forward_count} zu sehen, durchsucht die Vorwärtssuche die meisten Posets, bei ungefähr $k = 6$ Vergleichen und die Rückwörtssuche bei $k = 12$.
