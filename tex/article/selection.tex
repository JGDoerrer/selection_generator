...
$\mathcal{O}(n)$. \cite{Blum1972, HoareQuickselect}
...
$n+\min(i,n-i)-\mathcal{O}(1)$ comparisons \todo{cite}, thus matching the average case of the Floyd-Rivest
...
are required. An upper bound is been proposed by Blum, in the paper \textit{Time Bounds for
  Selection} \cite{Blum1972}. It stated that no more than $5.430\dot{5} \cdot n$ comparisons are ever required \todo{cite}.
...
\begin{figure}
  ...
  \caption{Logscaled number of posets generated by the backward search for $n = 14$ depending on the number of comparisons for various $i$}
...
\begin{table}
  \begin{tabular}{c|cccccccc}
    ...
    15  & 0                       & 36.390 & 8.173 & 1.683 & 0.460 & 0.133 & 0.066 & tbd. \\ % TODO: add value for 15,7
  \end{tabular}
  \centering
...
It is noteworthy that, due to technical constraints, the forward search utilized only XX GB of RAM. % TODO: genau Zahl einfügen
...
\begin{table}[htbp]
  \begin{tabular}{c|c|l|l}
    ...
    15         & 7          & 14d 1h 50m 45.3s         & tbd.                      \\  % TODO: add value for 15,7
  \end{tabular}
  \centering
