...
% \begin{proof}
%   Da $P$ reduziert ist, gilt für jedes Element $x$: $less[x] \leq i_P$ und $greater[x] \leq n_P - 1 - i_P$
...
It is noteworthy that, due to technical constraints, the forward search utilized only $500$ GB of RAM. % TODO: überarbeitet andi, oder 600 genau zahlen
