...
Furthermore, Oksanen's claim that `pair-forming algorithms', in which the first comparison of any singleton with another singleton is performed, does not lead to suboptimal results, since for $n = 12$ and $i = 4$ a non-optimal result follows under this assumption.
