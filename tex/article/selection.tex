...
\begin{definition}[Compatible Solution]
  As such we can define a \textbf{Compatible Solution} $Q = (n, i, S)$ of a poset $P=(n, i, R)$, to be solved and agreing with $P$, that is $(a, b)\in S\implies (b, a)\notin R$.
...
With Lemma \ref{lemma:partition}, a solved poset has exactly one compatile solution.
...
\begin{proof}
  ...
  %Then by induction $(n,i,R\cup \{(a, b)\})$ cannot be solved in less than $\lceil\log_2(|\mathcal{C}((n,i,R\cup \{(a, b)\}))|)\rceil$ comparisons.
