...
Using pivot algorithms like Floyd-Rivest algorithm, a variation of quickselect, the runtime can be reduced to $\mathcal{O}(\sqrt{n \cdot \log n})$.
...
\begin{itemize}
  ...
  \item[4.]
    In the last step, the minimum number of comparisons that still need to be removed until the empty poset is reached is calculated for each predecessor.
    This number corresponds to the edges in the corresponding Hasse diagram.
    Based on the known theoretical upper bounds, all posets that contain too many comparisons can be discarded, as these cannot lead to an empty poset in the remaining comparisons and therefore cannot be considered in the forward search.
...
\begin{table}[!t]
  ...
  \begin{tabular}{l|r|l}
    ...
    \hline
    $1$          & 7h 2m 59s & $1.000$    \\
    $2$          & tbd.      & tbd.       \\  % TODO: add value for 2
    $4$          & 2h 41s    & $0.877$    \\
    $8$          & 1h 2m 9s  & $0.851$    \\
    $16$         & tbd.      & tbd.       \\ % TODO: add value for 16 cores
...
\begin{table}[!t]
  \renewcommand{\arraystretch}{1.2}
  \caption{The minimum amount of comparisons needed to select the $i$-th smallest of $n$ elements.}
...
\begin{table}[!t]
  \renewcommand{\arraystretch}{1.2}
  \caption{Comparison of the times for the forward and backward search (note: the forward search runs single threaded, in contrast to the backward search which benefits greatly from parallelism; the forward search was started with 500gb RAM; the column `Oksanen' shows the times of his program \cite{Oksanen} on our hardware); the program from Oksanen was started with only 25gb due to the fact, that it was designed for 400mb RAM; the numbers marked with an asterisk by Oksanen do not provide the perfect lower bound in the public available version 1.6, even if he has specified a perfect algorithm on the website with the unavailable version 1.1}
  ...
  \begin{tabular}{c|c|l|l|l}
    ...
    13         & 4          & 3m 42s                  & 1m 40s                   & tbd.             \\
    13         & 5          & 17m 10s                 & 8m 35s                   & tbd.             \\
    13         & 6          & 59m 20s                 & 18m 5s                   & tbd.             \\
    \hline
    14         & 0          & 0.0s                    & 0.0s                     & tbd.             \\
    14         & 1          & 0.0s                    & 1.5s                     & tbd.             \\
    14         & 2          & 1.4s                    & 5.9s                     & tbd.             \\
    14         & 3          & 35.9s                   & 46.9s                    & tbd.             \\
    14         & 4          & 17m 27s                 & 15m 33s                  & tbd.             \\
    14         & 5          & 2h 40m                  & 1h 40m                   & tbd.             \\
    14         & 6          & 14h 40m                 & 6h 27m                   & tbd.             \\
    \hline
    15         & 0          & 0.0s                    & 0.0s                     & tbd.             \\
    15         & 1          & 0.1s                    & 4.0s                     & tbd.             \\
    15         & 2          & 2.8s                    & 25.9s                    & tbd.             \\
    15         & 3          & 2m 24s                  & 13m 11s                  & tbd.             \\
    15         & 4          & 1h 12m                  & 45m 52s                  & tbd.             \\
    15         & 5          & 1d 16h 41m              & 19h 30m                  & tbd.             \\ % 15,5: forward search, old value
    15         & 6          & 12d 13h 43m             & 1d 5h 43m                & tbd.             \\ % 15,6: forward search, old value
    15         & 7          & 14d 1h 51m              & 3d 8h 9m                 & tbd.             \\
    % TODO: add values
  \end{tabular}
\end{table}

% TODO: hier muss noch hin, dass die werte gerundet wurden und eh nicht 100% genau sind, da wir uns teils die Server geteilt haben
...
% TODO: und hier noch a sätzchen, dass werte von oksanen auch noch nicht optimal

\begin{table}[!t]
  \renewcommand{\arraystretch}{1.2}
  \caption{Number of posets stored in the cache after the corresponding search (note: the fewer entries stored in the cache, the less RAM is needed by the corresponding search)}
  ...
  \begin{tabular}{c|c|r|r}
    ...
    15         & 5          & tbd. $\cdot 10^6$       & $729.7 \cdot 10^6$       \\
    15         & 6          & tbd. $\cdot 10^9$       & $1.3 \cdot 10^9$         \\
    15         & 7          & $15.7 \cdot 10^9$       & $2.2 \cdot 10^9$         \\
    % TODO: add values
  \end{tabular}
\end{table}

See Table~\ref{table:cache_entries}.
...
Along the way we learned a lot about the problem structure and complexity, improved our forward and backward search algorithms coming to a final conclusion that both are valid and have their strength an weaknesses as stated in (\ref{}). % TODO: ref fehlt
...
It is noteworthy that, due to technical constraints, the forward search utilized only 500gb of RAM. % TODO: genau zahlen
