...
\begin{itemize}
  ...
  \item[3.]
    ...
    Additionally, by adding the comparison $u < v$, as in the first and second steps, followed by subsequent normalisation, the resulting poset $P$ should be obtained anew.
