...
\begin{itemize}
  ...
  \item[3.]
    ...
    % Die Menge der Posets im zweiten Schritt bildet eine Teilmenge aller potenziell möglichen Vorgänger.
    % Um im vorletzten Schritt alle möglichen Vorgänger zu berechnen, wird die existierende Menge iterativ um ein Element erweitert.
