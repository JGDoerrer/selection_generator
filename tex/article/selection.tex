...
The times are rounded and may not be representative, as the server they were measured on was shared with other people.
...
The forward search was started with 500 GB RAM, and for each value of $n$ and $i$ it was restarted, meaning that it does not use the cache from previous runs.
The column 'Oksanen' shows the times of his program \cite{Oksanen} on our hardware.
The program from Oksanen was started with only 25 GB due to the fact, that it was designed for 400 MB RAM.
