...
\begin{frame}{Previous Work on Exact Bounds}
  ...
  \note{
    \begin{itemize}
      ...
      \item We also address the selection problem using computer search. We reimplemented the minimax algorithm used in and improve upon it by introducing suitable heuristics. Additionally we performed backward search, which is another significant improvement over the minimax algorithm.
