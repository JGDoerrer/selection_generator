...
% \begin{frame}{Pruning technique: Compatible solutions}
%   \includegraphics[scale=0.5]{figures/Pruning_Compatible_Solution/Folie4.JPG}
% \end{frame}

% \begin{frame}{Pruning technique: Compatible solutions}
%   \includegraphics{figures/Pruning_Compatible_Solution/Folie5.JPG}
% \end{frame}

% \begin{frame}{Pruning technique: Compatible solutions}
%   \includegraphics{figures/Pruning_Compatible_Solution/Folie6.JPG}
% \end{frame}
