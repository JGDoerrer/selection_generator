...
\begin{frame}{The Selection Problem}
  \textit{Selection(n,i):} Find the $i$th-smallest value in a collection of $n$ values.\\
  \vspace{5mm}
  \textit{Base-line algorithms:}\\ \vspace*{5mm}
  \centering
  \begin{tabular}{c c}
    Sorting & Pivoting \\

    \footnote{https://medium.com/@teamtechsis/introduction-to-sorting-algorithms-1623b9cdd4f1} \hspace*{-1mm}\includegraphics[width=0.3\textwidth, trim={0 0 0 3.5cm},clip]{figures/Insertion_sort.jpg} & 
    
    \footnote{https://www.geeksforgeeks.org/dsa/quick-sort-algorithm/}\hspace*{-1mm} \includegraphics[width=0.3\textwidth]{figures/Pivot.jpg} 
  \end{tabular}

  %notes
  \note{\begin{itemize}
    \item 
    However, we focused on the exact number of comparisons required to solve the problem for relatively small numbers.
    Namely determining the number of comparisons needed to find the $i$-th smallest value in a collection of $n$ values.
...
\begin{frame}{Complexity of the Selection Problem}
  \begin{figure}
    \includegraphics[height=0.8\textheight]{figures/bounds_diagram.png}
...
\begin{frame}{Minimax Search Tree}
  \centering
  \begin{tikzpicture}
    [
...
% \begin{frame}{Pruning technique: Compatible solutions}
%   \includegraphics[scale=0.5]{figures/Pruning_Compatible_Solution/Folie4-min.JPG}
% \end{frame}

% \begin{frame}{Pruning technique: Compatible solutions}
%   \includegraphics[scale=0.5]{figures/Pruning_Compatible_Solution/Folie5-min.JPG}
% \end{frame}

% \begin{frame}{Pruning technique: Compatible solutions}
%   \includegraphics[scale=0.5]{figures/Pruning_Compatible_Solution/Folie6-min.JPG}
% \end{frame}
