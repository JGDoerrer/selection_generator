...
\begin{frame}{The Selection Problem}
  ...
  \note{
    \begin{itemize}
      ...
      \item However, this is not the most efficient way, since sorting takes $\mathcal{O}(n log n)$
...
\begin{frame}{Optimizations}
  ...
  \note{
    \begin{itemize}
      ...
      \item We applied iterative deepening to the depth-first search.
...
\begin{frame}{Pruning techniques}
  ...
  \begin{columns}
    \begin{column}{0.65\textwidth}
      ...
      \item<3-> Search for unrelated elements $a$ and $b$ such that $a$ a is small and $b$ is large
    \end{itemize}
    \end{column}
...
\begin{frame}{Pruning techniques}
  ...
  \only<2>{
    \begin{tikzpicture}
      ...
      \draw[red] (-0.3,-0.5) -- (.4,-1);
      \draw[red] (-0.3,-1) -- (.3,-0.5);

      \draw[red] (1.7,-0.5) -- (2.4,-1);
      \draw[red] (1.7,-1) -- (2.4,-0.5);
