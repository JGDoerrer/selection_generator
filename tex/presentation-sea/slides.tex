...
\end{tikzpicture}
  \note{
    \begin{itemize}
    \item Every node represents a function call on the Poset.
    \item Minimax is used to choose the optimal comparison but still take into acount the worst case outcome of that compariosn.
    \end{itemize} }
\end{frame}
