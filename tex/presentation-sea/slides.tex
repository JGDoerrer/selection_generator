  ...
  \begin{columns}
    \begin{column}{0.6\textwidth}
      \begin{itemize}
        ...
        \item<4-> \textbf{Use canonical representation}
      \end{itemize}
    \end{column}
...
\begin{frame}{Pruning techniques}
  ...
  \only<1>{
    \begin{tikzpicture}
      ...
      \node [draw=none] at (-0.8, -3) {\color{red} $=P$};
  ...
  \only<2>{
    \begin{tikzpicture}
      ...
      \node [draw=none] at (-0.8, -3) {\color{red} $=P$};
      \node [draw=none] at (1.8, -2.25) {\color{red} If $\lceil \log (\vert \mathcal{C}(P,i)\vert ) \rceil > $ remaining comparisons allowed};
