...
% TODO: ist diese Slide sinnvoll, wenn ja: translate to english
...
\begin{frame}{\insertsubsection}
  ...
  \begin{figure}
    \vspace{-0.5cm}
    \includegraphics[width=0.6\textwidth]{../article/figures/compatible_cost_relation.png}
    \caption{TODO: hier muss eine aussagekräftige Legende hin}
  \end{figure}
\end{frame}
