...
\begin{frame}{Optimizations}
  ...
  \timenote{
    ...
    \begin{itemize}
      ...
      \item This hash value is computed for the root timenote and all other nodes iteratively, based on their in and out-degrees and the hash of the adjacent nodes.
