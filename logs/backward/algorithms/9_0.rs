...
fn select_3([a, b, c, d, e, f]: [usize; 6], is_dual: bool) -> usize {
    if (!is_dual && c < f) || (is_dual && c > f) {
        select_4([a, b, c, d, e], is_dual)
    } else {
        select_4([a, b, d, e, f], is_dual)
    }
}
/// n = 7, i = 0
fn select_2([a, b, c, d, e, f, g]: [usize; 7], is_dual: bool) -> usize {
    if (!is_dual && c < g) || (is_dual && c > g) {
        select_3([a, b, c, d, e, f], is_dual)
    } else {
        select_3([a, b, d, e, f, g], is_dual)
    }
}
/// n = 8, i = 0
fn select_1([a, b, c, d, e, f, g, h]: [usize; 8], is_dual: bool) -> usize {
    if (!is_dual && d < h) || (is_dual && d > h) {
        select_2([a, b, c, d, e, f, g], is_dual)
    } else {
        select_2([a, b, c, e, f, g, h], is_dual)
    }
}
/// n = 9, i = 0
fn select_0([a, b, c, d, e, f, g, h, i]: [usize; 9], is_dual: bool) -> usize {
    if (!is_dual && c < i) || (is_dual && c > i) {
        ...
        select_1([a, b, d, e, f, g, h, i], is_dual)
    }
}
