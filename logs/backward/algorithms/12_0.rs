...
fn select_7([a, b, c, d, e]: [usize; 5], is_dual: bool) -> usize {
    if (!is_dual && d < e) || (is_dual && d > e) {
        ...
        select_8([a, b, c, e], is_dual)
    }
}
/// n = 6, i = 0
fn select_6([a, b, c, d, e, f]: [usize; 6], is_dual: bool) -> usize {
    if (!is_dual && c < f) || (is_dual && c > f) {
        select_7([a, b, c, d, e], is_dual)
    } else {
        select_7([a, b, d, e, f], is_dual)
    }
}
/// n = 7, i = 0
...
fn select_0([a, b, c, d, e, f, g, h, i, j, k, l]: [usize; 12], is_dual: bool) -> usize {
    if (!is_dual && k < l) || (is_dual && k > l) {
        ...
        select_1([a, b, c, d, e, f, g, h, i, j, l], is_dual)
    }
}
