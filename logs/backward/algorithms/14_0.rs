...
fn select_8([a, b, c, d, e, f]: [usize; 6], is_dual: bool) -> usize {
    if (!is_dual && c < f) || (is_dual && c > f) {
        select_9([a, b, c, d, e], is_dual)
    } else {
        select_9([a, b, d, e, f], is_dual)
    }
}
/// n = 7, i = 0
fn select_7([a, b, c, d, e, f, g]: [usize; 7], is_dual: bool) -> usize {
    if (!is_dual && c < g) || (is_dual && c > g) {
        ...
        select_8([a, b, d, e, f, g], is_dual)
    }
}
/// n = 8, i = 0
fn select_6([a, b, c, d, e, f, g, h]: [usize; 8], is_dual: bool) -> usize {
    if (!is_dual && d < h) || (is_dual && d > h) {
        select_7([a, b, c, d, e, f, g], is_dual)
    } else {
        select_7([a, b, c, e, f, g, h], is_dual)
    }
}
/// n = 9, i = 0
fn select_5([a, b, c, d, e, f, g, h, i]: [usize; 9], is_dual: bool) -> usize {
    if (!is_dual && c < i) || (is_dual && c > i) {
        select_6([a, b, c, d, e, f, g, h], is_dual)
    } else {
        select_6([a, b, d, e, f, g, h, i], is_dual)
    }
}
/// n = 10, i = 0
...
fn select_0([a, b, c, d, e, f, g, h, i, j, k, l, m, n]: [usize; 14], is_dual: bool) -> usize {
    if (!is_dual && g < n) || (is_dual && g > n) {
        ...
        select_1([a, b, c, d, e, f, h, i, j, k, l, m, n], is_dual)
    }
}
